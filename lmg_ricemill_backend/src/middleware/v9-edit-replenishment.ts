...
import {
  ...
  IResponseFail,
  ILoginResponse,
  TParamsEditReplenishment,
} from "@/types/main_schema";
import { db } from "@/config/drizzle/connectdb";
import { users } from "@/config/drizzle/schema";
import { and, eq } from "drizzle-orm";

const MW_v9_edit_replenishment = async (
  req: Request<{}, {}, TParamsEditReplenishment>,
  ...
  const isEmpty: boolean = !productid || !expenseid;
...
export default MW_v9_edit_replenishment;
